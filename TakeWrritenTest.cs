...
{
    public partial class TakeWrritenTest: Form
    {
        public TakeWrritenTest()
        {
            InitializeComponent();
        }
        ...
        public TakeWrritenTest(int TestAppointmentID, int DrivingLicenseID, string ClassName, string FullName, DateTime ApplicationDate)
        {
        ...
        private void TakeWrritenTest_Load(object sender, EventArgs e)
        {
