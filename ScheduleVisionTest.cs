...
namespace DVLDInterface
{
    public partial class ScheduleVisionTest: Form
    {
        ...
        public ScheduleVisionTest(int LocalDrivingLicenseID,string ClassName ,string FirstName, string SecondName, string ThirdName, string LastName)
        {
            InitializeComponent();
        ...
        public ScheduleVisionTest(int AppointmentID,int LocalDrivingLicenseID, string ClassName, DateTime AppointmentDate, string FirstName, string SecondName, string ThirdName, string LastName)
        {
            InitializeComponent();
        ...
        public ScheduleVisionTest(int AppointmentID, int LocalDrivingLicenseID, string ClassName, DateTime AppointmentDate, string FirstName, string SecondName, string ThirdName, string LastName, bool IsLocked)
        {
            InitializeComponent();
            this.AppointmentID = AppointmentID;
            lblFullName.Text = FirstName + " " + SecondName + " " + ThirdName + " " + LastName;
        ...
        public ScheduleVisionTest(bool IsForReTake, int LocalDrivingLicenseID, string ClassName, string FirstName, string SecondName, string ThirdName, string LastName)
        {
            InitializeComponent();
            lblFullName.Text = FirstName + " " + SecondName + " " + ThirdName + " " + LastName;
            lblDrivingClass.Text = ClassName;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!IsForEdit)
            {
               int ID = -1;
                ...
                if (IsForReTake)
                {
                    ID = clsPerson.AddNewAppointments(1, DLAppID, dateTimePicker1.Value, 15, clsCurrentUser.CurrentUser.UserID);
                ...
                {
                    ID = clsPerson.AddNewAppointments(1, DLAppID, dateTimePicker1.Value, 10, clsCurrentUser.CurrentUser.UserID);
