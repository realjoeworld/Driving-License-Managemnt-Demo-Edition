...
{
    public partial class ScheduleWrritenTest: Form
    {
        public ScheduleWrritenTest()
        {
            InitializeComponent();
        }
        ...
        public ScheduleWrritenTest(int LocalDrivingLicenseID, string ClassName, string FirstName, string SecondName, string ThirdName, string LastName)
        {
            InitializeComponent();
        ...
        public ScheduleWrritenTest(int AppointmentID, int LocalDrivingLicenseID, string ClassName, DateTime AppointmentDate, string FirstName, string SecondName, string ThirdName, string LastName)
        {
            InitializeComponent();
        ...
        public ScheduleWrritenTest(int AppointmentID, int LocalDrivingLicenseID, string ClassName, DateTime AppointmentDate, string FirstName, string SecondName, string ThirdName, string LastName, bool IsLocked)
        {
            InitializeComponent();
            this.AppointmentID = AppointmentID;
            lblFullName.Text = FirstName + " " + SecondName + " " + ThirdName + " " + LastName;
        ...
        public ScheduleWrritenTest(bool IsForReTake, int LocalDrivingLicenseID, string ClassName, string FirstName, string SecondName, string ThirdName, string LastName)
        {
            InitializeComponent();
            lblFullName.Text = FirstName + " " + SecondName + " " + ThirdName + " " + LastName;
            lblDrivingClass.Text = ClassName;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (!IsForEdit)
            {
                ...
                if (IsForReTake)
                {
                    ID = clsPerson.AddNewAppointments(2, DLAppID, dateTimePicker1.Value, 25, clsCurrentUser.CurrentUser.UserID);
                ...
                {
                    ID = clsPerson.AddNewAppointments(2, DLAppID, dateTimePicker1.Value, 20, clsCurrentUser.CurrentUser.UserID);
        ...
        private void ScheduleWrritenTest_Load(object sender, EventArgs e)
        {
